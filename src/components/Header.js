...
const Header = ({ setOpenLogin }) => {
  return (
    <div className='h-screen container mx-auto mb-40 max-md:mb-10 overflow-hidden'>
      <Navbar />

      <div className='flex items-center h-3/4 max-md:flex-col-reverse max-md:gap-8'>
        <div className='basis-1/2 px-10 max-md:px-4 max-sm:text-center'>
          <h1 className='text-6xl text-gray-500 leading-tight max-md:text-xl'>The work blog of a junior frontend developer</h1>
