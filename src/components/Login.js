        ...
        <div className='relative z-10 transition-all' aria-labelledby="modal-title" role="dialog" aria-modal="true">
            <div className="fixed inset-0 overflow-y-auto">
                ...
                <div className="flex min-h-full justify-center p-4 text-center items-center">
                    <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 w-full sm:max-w-4xl flex py-14 px-20 justify-between">
                        {/* Popup content */}
                        <div onClick={() => setOpenLogin(false)} className="text-gray-200 text-xl absolute right-10 top-7 w-8 h-8 rounded-full hover:bg-gray-50 cursor-pointer flex items-center justify-center">X</div>
                        <form onSubmit={handleSubmit} className="flex flex-col justify-between">
                            ...
                            <input onChange={(e) => setEmail(e.target.value)} type="text" placeholder="Email" className="bg-gray-100 p-4 rounded text-center" />
                            <input onChange={(e) => setPassword(e.target.value)} type="text" placeholder="Email" className="bg-gray-100 p-4 rounded text-center" />
                        ...
                        <img src={LoginImg} alt='Undraw login' height={300} width={300} />
                    </div>
                </div>
            </div>
        </div>
